...
<?php echo sprintf(__('To open your %s homepage, please follow this link:'), $site_name); ?>
<br />
<br />
<big style="font: 16px/18px Arial, Helvetica, sans-serif;"><b><a href="<?php echo site_url('/auth/login/'); ?>" style="color: #3366cc;"><?php echo sprintf(__('Go to %s now!'), $site_name); ?></a></b></big><br />
<br />
