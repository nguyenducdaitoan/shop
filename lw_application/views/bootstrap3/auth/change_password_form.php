...
<div class="form-group">
    <?php echo form_label(__('Old Password'), $old_password['id'],$label_attributes); ?>
    <div class="col-sm-6 col-md-6 col-lg-4">
      <?php echo form_password($old_password); ?>
		<span class="help-inline error_msg">
			<?php echo form_error($old_password['name']); ?><?php echo isset($errors[$old_password['name']])?$errors[$old_password['name']]:''; ?></span>
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-6 col-md-6 col-lg-4">
      <?php echo form_password($new_password); ?>
		<span class="help-inline error_msg"><?php echo form_error($new_password['name']); ?><?php echo isset($errors[$new_password['name']])?$errors[$new_password['name']]:''; ?></span>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6 col-md-6 col-lg-4">
     <?php echo form_password($confirm_new_password); ?>
			<span class="help-inline error_msg">
				<?php echo form_error($confirm_new_password['name']); ?><?php echo isset($errors[$confirm_new_password['name']])?$errors[$confirm_new_password['name']]:''; ?></span>
    </div>
  </div>
<div class="form-group">
